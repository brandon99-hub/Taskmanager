...
export function MarketingProspectsTable() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm("Are you sure you want to delete this prospects record?")) return;
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Track your prospects and potential opportunities
        </CardDescription>
              ...
              {prospects.length === 0 ? (
                ...
                prospects.map((prospect) => (
                  <TableRow key={prospect.id}>
                    <TableCell className="font-medium">{prospect.organisationName}</TableCell>
                    <TableCell>{prospect.sector}</TableCell>
                    <TableCell>{prospect.product}</TableCell>
                    <TableCell>{formatCurrency(prospect.revenue)}</TableCell>
                    <TableCell>
                      <Badge className={quarterColors[prospect.expectedQuarter]}>
                        {prospect.expectedQuarter}
                      </Badge>
                    </TableCell>
